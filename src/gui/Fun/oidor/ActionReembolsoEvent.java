		...
		if(!(dat1.equals("")||dat1==null)) {
			...
			if(!(pago==null)) {
				...
				if (operacion == true) {
					...
					//new FileInputStream(System.getProperty("user.dir") + "\\src\\imagenes\\setAsiento.png")
					try {
						Image image2 = new Image(new FileInputStream(System.getProperty("user.dir") + "\\src\\imagenes\\Money.png"));
					...
					Image image2;
					try {
						image2 = new Image(new FileInputStream(System.getProperty("user.dir") + "\\src\\imagenes\\F.png"));
						ImageView ImT1= new ImageView(image2);
						ImT1.setFitHeight(150);
						ImT1.setFitWidth(150);
						Reemb.getChildren().add(ImT1);
